...
function Dropdown({ id, size, name }: DropdownProps) {
  ...
  return (
    <div className="relative inline-block">
      ...
      <div
        className={`absolute right-0 mt-2 z-10 ${dropdownVisible ? 'block' : 'hidden'
      ...
      >
        <ul className="py-2 text-sm text-gray-700 dark:text-gray-200" aria-labelledby={id}>
          ...
          <li>
            <a href="/drafts" className="block px-4 py-2 hover:bg-gray-100 dark:hover:bg-gray-600 dark:hover:text-white">
              Drafts
            </a>
          </li>
        </ul>
